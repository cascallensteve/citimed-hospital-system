        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center space-x-3">
              <img src="/IMAGES/Logo.png" alt="Citimed-Clinic logo" className="h-28 w-auto object-contain" />
              <span className="text-xl font-semibold text-gray-900">Citimed-Clinic</span>
            </div>
