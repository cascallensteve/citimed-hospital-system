...
const Login = () => {
  ...
  // Removed password visibility toggle per design
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative rounded-lg shadow-sm">
                  ...
                  />
                  {/* Static eye icon (non-interactive) */}
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center text-blue-500/70">
